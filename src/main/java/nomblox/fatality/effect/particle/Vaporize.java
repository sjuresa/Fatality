...
public class Vaporize extends ParticleEffect implements FatalityEffect {
    public static final String NAME = "Vaporize";

    public Vaporize(EffectSettingsDto effectSettingsDto) {
    ...
    public void playEffect(LivingEntity livingEntity, Player player, Location location) {
        spawnParticle(Particle.CLOUD, player, location, 10, 1, new Vector(0, 0.1, 0));
    }
}