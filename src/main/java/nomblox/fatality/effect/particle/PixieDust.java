...
public class PixieDust extends ParticleEffect implements FatalityEffect {
    public static final String NAME = "Pixie dust";

    public PixieDust(EffectSettingsDto effectSettingsDto) {
    ...
    public void playEffect(LivingEntity livingEntity, Player player, Location location) {
        spawnParticle(Particle.VILLAGER_HAPPY, player, location, 10, 0.3);
    }
}